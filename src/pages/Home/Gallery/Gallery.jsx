            ...
            <div className="md:p-2 p-1 w-1/2">
              <Zoom>
                <img
                  alt="gallery"
                  className="w-full object-cover h-full object-center block"
                  src="https://images.pexels.com/photos/8197534/pexels-photo-8197534.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                />
              </Zoom>
            </div>
            ...
            <div className="md:p-2 p-1 w-full">
              <Zoom>
                <img
                  alt="gallery"
                  className="w-full h-full object-cover object-center block"
                  src="https://images.pexels.com/photos/7092339/pexels-photo-7092339.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                />
              </Zoom>
            </div>
            <div className="md:p-2 p-1 w-1/2">
            ...
            <div className="md:p-2 p-1 w-1/2">
              <Zoom>
                <img
                  alt="gallery"
                  className="w-full object-cover h-full object-center block"
                  src="https://images.pexels.com/photos/6503155/pexels-photo-6503155.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                />
              </Zoom>
            </div>
          </div>
