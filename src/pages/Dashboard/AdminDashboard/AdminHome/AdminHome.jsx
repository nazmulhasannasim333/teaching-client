...
const AdminHome = () => {
  ...
  const totalClass = classes?.reduce(
    (total, oneClass) => total + oneClass.price,
    0
  );
 ...
 <div id="main-content" className="h-full w-full bg-gray-50 relative overflow-y-auto">
   <main>
     ...
     <div className="my-4 w-full grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
         <div className="bg-gradient-to-r from-yellow-500 text-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
           <div className="flex items-center">
             <div className="flex-shrink-0">
             <FaFunnelDollar className="font-bold text-3xl" />
               <span className="text-2xl sm:text-3xl leading-none font-bold ">${totalClass}</span>
               <h3 className="text-base font-normal ">Total Sale value this week</h3>
             </div>
         ...
         <div className="bg-gradient-to-r from-orange-500 text-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
           <div className="flex items-center">
             <div className="flex-shrink-0">
             <FaBookDead className="font-bold text-2xl" />
               <span className="text-2xl sm:text-3xl leading-none font-bold ">{classes.length}</span>
               <h3 className="text-base font-normal ">Total Class</h3>
             </div>
             <div className="ml-5 w-0 flex items-center justify-end flex-1 text-green-500 text-base font-bold">
               32.9%
               <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
         ...
         <div className="bg-gradient-to-r from-indigo-500 text-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
           <div className="flex items-center">
             <div className="flex-shrink-0">
             <FaUsers className="font-bold text-3xl" />
               <span className="text-2xl sm:text-3xl leading-none font-bold ">  {users.length}</span>
       ...
       <div className="bg-white shadow rounded-lg mb-4 p-4 sm:p-6 h-full">
           ...
           <div className="flow-root">
             <ul role="list" className="divide-y divide-gray-200">
                {
                    users.slice(0, 6).map(user => <li key={user._id} className="py-3 sm:py-4">
                    <div className="flex items-center space-x-4">
                      <div className="flex-shrink-0">
                        <img className="h-8 w-8 rounded-full" src={user.photo} alt="Neil image" />
                      </div>
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm text-gray-500 truncate">
                          <a href="/cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="17727a767e7b57607e7973646372653974787a">{user.email}</a>
                        </p>
                      </div>
               ...
               <div className="align-middle inline-block min-w-full">
                 <div className="shadow overflow-hidden sm:rounded-lg">
                   <table className="min-w-full divide-y divide-gray-200">
                     ...
                     {
                        allpayment.slice(0, 6).map(payment =>  <tr key={payment._id}>
