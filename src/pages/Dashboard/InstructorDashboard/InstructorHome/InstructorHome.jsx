...
const InstructorHome = () => {
  ...
  const { data: instructorpayment=[], refetch  } = useQuery({
      queryKey: ['instructorpayment', user?.displayName],
      enabled: !loading,
      queryFn: async () => {
    ...
    const totalPayment = instructorpayment?.reduce(
  ...
  return (
    ...
    <div className="sticky z-10 top-0 h-16 border-b bg-white lg:py-2.5">
      <div className="px-6 flex items-center justify-between space-x-4 2xl:container">
        <h5 hidden className="text-2xl text-gray-600 font-semibold lg:block">Instructor Dashboard</h5>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        <div className="md:col-span-2 lg:col-span-1">
          <div className="h-full py-8 px-6 space-y-6 rounded-xl border border-gray-200 bg-white">
            ...
            <div>
              <h5 className="text-xl text-gray-600 text-center">Total Classes</h5>
              <div className="mt-2 flex justify-center gap-4">
                <h3 className="text-3xl font-bold text-gray-700">{classes.length}</h3>
            ...
            <table className="w-full text-gray-600">
              <tbody>
                <tr>
                  <td className="py-2">Hindi Language</td>
                ...
                <tr>
                  <td className="py-2">English Language</td>
                ...
                <tr>
                  <td className="py-2">Arabic Language</td>
        ...
        <div>
          <div className="h-full py-6 px-6 rounded-xl border border-gray-200 bg-white">
            <h5 className="text-xl text-gray-700">Total Sales Value</h5>
            <div className="my-8">
              <h1 className="text-5xl font-bold text-gray-800">${totalPayment}</h1>
            ...
            <table className="mt-6 -mb-2 w-full text-gray-600">
              <tbody>
                <tr>
                  <td className="py-2">From new student</td>
                  <td className="text-gray-500">896</td>
                  <td>
                    <svg className="w-16 ml-auto" viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <rect opacity="0.4" width={17} height={21} rx={1} fill="#e4e4f2" />
                ...
                <tr>
                  <td className="py-2">From old student</td>
                  <td className="text-gray-500">1200</td>
                  <td>
                    <svg className="w-16 ml-auto" viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <rect opacity="0.4" width={17} height={21} rx={1} fill="#e4e4f2" />
        ...
        <div>
          <div className="lg:h-full py-8 px-6 text-gray-600 rounded-xl border border-gray-200 bg-white">
            ...
            <div className="mt-6">
              <h5 className="text-xl text-gray-700 text-center">Total Orderd Product</h5>
              <div className="mt-2 flex justify-center gap-4">
                <h3 className="text-3xl font-bold text-gray-700">{instructorpayment.length}</h3>
                <div className="flex items-end gap-1 text-green-500">
                  <svg className="w-3" viewBox="0 0 12 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M6.00001 0L12 8H-3.05176e-05L6.00001 0Z" fill="currentColor" />
                  </svg>
            ...
            <table className="mt-6 -mb-2 w-full text-gray-600">
              <tbody>
                <tr>
                  ...
                  <td className="text-gray-500">$16</td>
                  <td>
                    <svg className="w-16 ml-auto" viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <rect opacity="0.4" width={17} height={21} rx={1} fill="#e4e4f2" />
                      <rect opacity="0.4" x={19} width={14} height={21} rx={1} fill="#e4e4f2" />
                ...
                <tr>
                  ...
                  <td className="text-gray-500">$120</td>
                  <td>
                    <svg className="w-16 ml-auto" viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <rect opacity="0.4" width={17} height={21} rx={1} fill="#e4e4f2" />
                      <rect opacity="0.4" x={19} width={14} height={21} rx={1} fill="#e4e4f2" />
                ...
                <tr>
                  <td className="py-2">Last year</td>
                  <td className="text-gray-500">$1265</td>
                  <td>
                    <svg className="w-16 ml-auto" viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <rect opacity="0.4" width={17} height={21} rx={1} fill="#e4e4f2" />
                      <rect opacity="0.4" x={19} width={14} height={21} rx={1} fill="#e4e4f2" />
