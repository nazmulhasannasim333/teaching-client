    ...
    <div className="flex flex-wrap -m-4">
      <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
        <div className="h-full text-center">
          ...
          <h2 className=" font-medium title-font tracking-wider text-sm uppercase">Md Arman PK</h2>
      ...
      <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
        <div className="h-full text-center">
          ...
          <span className="inline-block h-1 w-10 rounded bg-indigo-500 mt-6 mb-4" />
          <h2 className=" font-medium title-font tracking-wider text-sm uppercase">Suborna Khatun</h2>
      ...
      <div className="lg:w-1/3 lg:mb-0 p-4">
        <div className="h-full text-center">
          ...
          <span className="inline-block h-1 w-10 rounded bg-indigo-500 mt-6 mb-4" />
          <h2 className=" font-medium title-font tracking-wider text-sm uppercase">Md Nahid Khan</h2>
