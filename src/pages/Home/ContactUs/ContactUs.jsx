...
const ContactUs = () => {
    ...
    <div className="max-w-screen-xl mt-24 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-gray-50 text-gray-900 rounded-lg">
      ...
      <div className>
        ...
        <div className="mt-8">
          <button className="uppercase text-sm font-bold tracking-wide bg-purple-500 text-gray-100 p-3 rounded-lg w-full focus:outline-none focus:shadow-outline">
            Send Message
          </button>
        </div>
      </div>
